...
void SplashScreenPrint() {
	...
	for (int i = 0; i < SplashScreenHeight; i++) {
		...
		for (int j = 0; j < SplashScreenWidth; j++) {
			if (SplashScreen[i][j] == 'm') { SetColor(COLOR::black, COLOR::blue);   cout << u8"▓"; }
	    if (SplashScreen[i][j] == 'n') { SetColor(COLOR::black, COLOR::gray);	    cout << u8"▓"; }
	    if (SplashScreen[i][j] == 'u') { SetColor(COLOR::black, COLOR::blue);   	cout << u8"▓"; }
	    if (SplashScreen[i][j] == 'b') { SetColor(COLOR::black, COLOR::black);   	cout << u8"▓"; }
	    if (SplashScreen[i][j] == 'r') { SetColor(COLOR::black, COLOR::light_red);	cout << u8"▓"; }
	    if (SplashScreen[i][j] == 'y') { SetColor(COLOR::black, COLOR::red);	    cout << u8"▓"; }
	    if (SplashScreen[i][j] == 'i') { SetColor(COLOR::black, COLOR::yellow);	    cout << u8"▓"; }
		if (SplashScreen[i][j] == '.') { SetColor(COLOR::black, COLOR::light_blue);	cout << u8"▓"; }
	    if (SplashScreen[i][j] == '*') { SetColor(COLOR::black, COLOR::aqua);	    cout << u8"▓"; }
		}
	}
	SetColor(COLOR::black, COLOR::gray);
}
...
void DrowGameName() {
	...
	for (int i = 0; i < GameNameHeight; i++) {
		...
		for (int j = 0; j < GameNameWidth; j++) {
			if (PrintGameName[i][j] == 'm') { SetColor(COLOR::black, COLOR::blue);         cout << u8"▓"; }
			if (PrintGameName[i][j] == 'n') { SetColor(COLOR::black, COLOR::gray);	       cout << u8"▓"; }
...
void DrowLittleShip() {
	...
	for (int i = 0; i < LittleShipHeight; i++) {
		...
		for (int j = 0; j < LittleShipWidth; j++) {
			if (PrintLittleShip[i][j] == 'u') { SetColor(COLOR::black, COLOR::blue);        cout << u8"▓"; }
			if (PrintLittleShip[i][j] == 'n') { SetColor(COLOR::black, COLOR::gray);	    cout << u8"▓"; }
			if (PrintLittleShip[i][j] == '.') { SetColor(COLOR::black, COLOR::light_blue);	cout << " ";   }
			if (PrintLittleShip[i][j] == '*') { SetColor(COLOR::black, COLOR::light_aqua);	cout << u8"▓"; }
			if (PrintLittleShip[i][j] == 'i') { SetColor(COLOR::black, COLOR::yellow);	    cout << u8"▓"; }
			if (PrintLittleShip[i][j] == 'r') { SetColor(COLOR::black, COLOR::light_red);	cout << u8"▓"; }
			if (PrintLittleShip[i][j] == 'y') { SetColor(COLOR::black, COLOR::red);	        cout << u8"▓"; }
		}
	}
	SetColor(COLOR::black, COLOR::gray);
}