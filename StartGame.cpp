...
void DrawWin() {
	...
	for (int i = 0; i < YouWonHeight; i++) {
		...
		for (int j = 0; j < YouWonWidth; j++) {
			if (YouWon[i][j] == 'u') { SetColor(COLOR::black, COLOR::yellow); cout << u8"▓"; }
			else if (YouWon[i][j] == 'n') { SetColor(COLOR::black, COLOR::gray); cout << u8"▒"; }
...
void DrawGameOver() {
	...
	for (int i = 0; i < GameOverHeight; i++) {
		...
		for (int j = 0; j < GameOverWidth; j++) {
			if (GameOver[i][j] == 'm') { SetColor(COLOR::black, COLOR::blue); cout << u8"▓"; }
			else if (GameOver[i][j] == 'n') { SetColor(COLOR::black, COLOR::gray); cout << u8"▒"; }
...
void PrintTable(string* pole, int i, int j) {
	if (pole == PolePl) {
		if (pole[i][j] == 'o') { SetColor(COLOR::light_blue, COLOR::black); cout << u8"▓"; }
		else if (pole[i][j] == '/') { SetColor(COLOR::yellow, COLOR::blue);	cout << u8"║"; }
		else if (pole[i][j] == '=') { SetColor(COLOR::yellow, COLOR::blue);	cout << u8"═"; }
		else if (pole[i][j] == '-') { SetColor(COLOR::light_blue, COLOR::blue);	cout << u8"═"; }
		else if (pole[i][j] == '|') { SetColor(COLOR::light_blue, COLOR::blue);	cout << u8"║"; }
		else if (pole[i][j] == '+') { SetColor(COLOR::light_blue, COLOR::blue);	cout << u8"╬"; }
		else if (pole[i][j] == 'T') { SetColor(COLOR::light_blue, COLOR::blue);	cout << u8"╦"; }
		else if (pole[i][j] == 'b') { SetColor(COLOR::light_blue, COLOR::blue);	cout << u8"╩"; }
		else if (pole[i][j] == 'r') { SetColor(COLOR::light_blue, COLOR::blue);	cout << u8"╣"; }
		else if (pole[i][j] == 'l') { SetColor(COLOR::light_blue, COLOR::blue);	cout << u8"╠"; }
		else if (pole[i][j] == 'q') { SetColor(COLOR::light_blue, COLOR::blue);	cout << u8"╔"; }
		else if (pole[i][j] == 'w') { SetColor(COLOR::light_blue, COLOR::blue);	cout << u8"╗"; }
		else if (pole[i][j] == 'e') { SetColor(COLOR::light_blue, COLOR::blue);	cout << u8"╝"; }
		else if (pole[i][j] == 'd') { SetColor(COLOR::light_blue, COLOR::blue);	cout << u8"╚"; }
		else if (pole[i][j] == '{') { SetColor(COLOR::yellow, COLOR::blue);	cout << u8"╔"; }
		else if (pole[i][j] == '}') { SetColor(COLOR::yellow, COLOR::blue);	cout << u8"╗"; }
		else if (pole[i][j] == '[') { SetColor(COLOR::yellow, COLOR::blue);	cout << u8"╚"; }
		else if (pole[i][j] == ']') { SetColor(COLOR::yellow, COLOR::blue);	cout << u8"╝"; }
		...
		else if (pole[i][j] == 'x') { SetColor(COLOR::light_blue, COLOR::light_red);	cout << u8"█"; }
		else { SetColor(COLOR::light_blue, COLOR::black);	cout << pole[i][j]; }
	}
	if (pole == PolePlAttack) {
		if (pole[i][j] == '/') { SetColor(COLOR::light_red, COLOR::blue);	cout << u8"║"; }
		else if (pole[i][j] == '=') { SetColor(COLOR::light_red, COLOR::blue);	cout << u8"═"; }
		else if (pole[i][j] == '-') { SetColor(COLOR::light_blue, COLOR::blue);	cout << u8"═"; }
		else if (pole[i][j] == '|') { SetColor(COLOR::light_blue, COLOR::blue);	cout << u8"║"; }
		else if (pole[i][j] == '+') { SetColor(COLOR::light_blue, COLOR::blue);	cout << u8"╬"; }
		else if (pole[i][j] == 'T') { SetColor(COLOR::light_blue, COLOR::blue);	cout << u8"╦"; }
